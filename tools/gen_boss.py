...
BODY = [
    ...
    (670, 226), (678, 232), (676, 256), (670, 286), (666, 306),  # right tentacle
    (674, 316), (680, 328), (676, 340), (664, 348), (650, 348), (630, 347), (612, 344), (602, 336),  # right hand
    (590, 330), (566, 334), (548, 336), (530, 334), (512, 330), (500, 338), (486, 346),  # underside
    (470, 347), (452, 346), (440, 344), (432, 332), (432, 316), (438, 304),  # left hand
    (428, 300), (403, 299), (403, 291), (424, 286), (442, 283),  # the bone spike
    (446, 270), (448, 250), (450, 242),                        # up the left arm
...
PARTS = [
    ...
    ("core", [(546 + round(32 * math.cos(t * math.pi / 12)), 248 + round(32 * math.sin(t * math.pi / 12)))
              for t in range(24)]),
    ("mace", [(446, 242), (480, 242), (498, 250), (498, 302), (496, 352), (430, 352), (403, 300),
              (402, 284), (440, 282), (446, 270)]),
    ("claws", [(596, 236), (674, 236), (682, 302), (696, 318), (698, 336), (680, 350), (598, 352),
               (594, 300)]),
    ("torso", None),
]
