...
const VARIANTS = [
  ['temple-only', { knights: 0, bullets: 0, layer: 'temple', frames: 60 }],
  ['boss-only', { knights: 0, bullets: 0, layer: 'boss', frames: 60 }],
  ['shipped-k20', { knights: 20, bullets: 128, knightArt: false, frames: 60 }],
  ['art-k20', { knights: 20, bullets: 128, knightArt: true, frames: 60 }],
  ['art-k20-feed714', { knights: 20, bullets: 128, knightArt: true, feedHz: 714, frames: 60 }],
];
