import{o as e}from"./rolldown-runtime-C_s2cVnS.js";import{n as t,t as n}from"./jsx-runtime-CMaQg7dW.js";import{ft as r,nn as i}from"./ModalFooter-FDXOM0ZR-dLPfJ137.js";import{c as a,t as o}from"./ethers-ComuOzvK-BDA-iX7t.js";import{n as s}from"./Layouts-BlFm53ED-8H6pAIS9.js";import{i as c,r as l,t as u}from"./WalletLink-uxzjkGGj-BiswrERT.js";var d=n(),f=e(t(),1),p=({label:e,children:t,valueStyles:n})=>(0,d.jsxs)(m,{children:[(0,d.jsx)(`div`,{children:e}),(0,d.jsx)(h,{style:{...n},children:t})]}),m=r.div`
  display: flex;
  align-items: center;
...
`,h=r.div`
  ...
  padding: 4px 8px;
`,g=({gas:e,tokenPrice:t,tokenSymbol:n})=>(0,d.jsxs)(s,{style:{paddingBottom:`12px`},children:[(0,d.jsxs)(v,{children:[(0,d.jsx)(b,{children:`Est. Fees`}),(0,d.jsx)(`div`,{children:(0,d.jsx)(l,{weiQuantities:[BigInt(e)],tokenPrice:t,tokenSymbol:n})})]}),t&&(0,d.jsx)(y,{children:`${o(BigInt(e),n)}`})]}),_=({value:e,gas:t,tokenPrice:n,tokenSymbol:r})=>{let i=BigInt(e??0)+BigInt(t);return(0,d.jsxs)(s,{children:[(0,d.jsxs)(v,{children:[(0,d.jsx)(b,{children:`Total (including fees)`}),(0,d.jsx)(`div`,{children:(0,d.jsx)(l,{weiQuantities:[BigInt(e||0),BigInt(t)],tokenPrice:n,tokenSymbol:r})})]}),n&&(0,d.jsx)(y,{children:o(i,r)})]})},v=r.div`
  display: flex;
  flex-direction: row;
  justify-content: space-between;
  align-items: center;
