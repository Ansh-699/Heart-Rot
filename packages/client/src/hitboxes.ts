 ...
 * is 3 arena units. The two spaces differ by `local = sprite * BOSS_SCALE +
 ...
 */
export const BOSS_ANCHOR_X = -345;
export const BOSS_ANCHOR_Y = -405;
...
export const PART_HITBOXES: readonly [Rect, Rect, Rect, Rect, Rect, Rect, Rect, Rect, Rect] = [
  { x: -48, y: -321, w: 63, h: 108 }, // 0 thorn0
  { x: 195, y: -294, w: 144, h: 195 }, // 1 thorn1
  { x: -90, y: -111, w: 60, h: 69 }, // 2 thorn2
  { x: 264, y: -24, w: 72, h: 51 }, // 3 thorn3
  { x: 21, y: -384, w: 201, h: 177 }, // 4 crown
  { x: -141, y: -258, w: 150, h: 159 }, // 5 wolf_l
  { x: 171, y: -249, w: 138, h: 156 }, // 6 beast_r
  { x: -342, y: -99, w: 333, h: 411 }, // 7 mace
  { x: 165, y: -114, w: 156, h: 330 }, // 8 claws
];
...
export const MUZZLES: readonly [Muzzle, Muzzle, Muzzle, Muzzle] = [
  { part: 0, x: -18, y: -273 }, // thorn0
  { part: 1, x: 270, y: -216 }, // thorn1
  { part: 2, x: -63, y: -75 }, // thorn2
  { part: 3, x: 288, y: 0 }, // thorn3
];
